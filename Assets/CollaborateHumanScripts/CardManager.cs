...
public class CardManager : MonoBehaviourPun, IPunObservable
{
    ...
    public CardDataManager cardDataManager; // Reference to CardDataManager
    ...
    void Start()
    {
        ...
        cardDataManager.LoadCardDataFromFolders();
    ...
    {
        currentGroup = cardDataManager.cardDatas;
    ...
    public void OnSubmitScore()
    {
        ...
        if (PhotonNetwork.IsMasterClient)
        {
            ...
            DisplayRandomPlayerName displayRandomPlayerName = FindObjectOfType<DisplayRandomPlayerName>();
            displayRandomPlayerName.photonView.RPC("CheckScore", RpcTarget.All,currentScore,currentPickedPlayer);

            CollaborateGameManager collaborateGameManager = FindObjectOfType<CollaborateGameManager>();
            if (collaborateGameManager != null)
            {
                collaborateGameManager.photonView.RPC("CheckIfAllPlayersPicked", RpcTarget.All);
            }
            else
            {
